...
MoleMole::EntityManager* MoleMole::EntityManager::GetEntityManager() {
	//return ((MoleMole::EntityManager * (*)())(g_game_base_addr + 0xC427720))();
	return InLevelDrumPageContext_get_ENTITY();
}

std::vector<MoleMole::BaseEntity*> MoleMole::EntityManager::GetEntities() {
	//auto entityList = ((Unity::List<MoleMole::BaseEntity*>*(*)(MoleMole::EntityManager*))(g_game_base_addr + 0x100132F0))(this);
...
Unity::GameObject* MoleMole::BaseEntity::GetGameObject() {
	//return ((Unity::GameObject * (*)(MoleMole::BaseEntity*))(g_game_base_addr + 0xC7F3490))(this);
