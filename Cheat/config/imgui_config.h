...
namespace ImGuiEx {
	...
	bool Checkbox(const char* label, ConfigVar<bool>& var);

	bool SliderFloat(const char* label, ConfigVar<float>& var, float min, float max);

	bool SliderFloat2(const char* label, ConfigVar<ImVec2>& var, float min, float max);
	...
	bool SliderFloat3(const char* label, ConfigVar<ImVec3>& var, float min, float max);
